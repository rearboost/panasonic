...
--
-- Host: localhost:8889
-- Generation Time: Feb 23, 2021 at 12:47 PM
...
`bill_amount`,
`discount
`, `discounted_amt`, `cost`, `cash`, `credit`, `cheque`, `cheque_no`, `cheque_date`, `cheque_status`) VALUES
...
c_id`,
`invoice_no
`, `cdate`, `month`, `year`, `amount`, `type`, `remain`, `credit_status`) VALUES
...
`category`,
`item_name
`, `batch_no`, `size`, `purchase_cost`, `sales_cost`, `warehouse_stock`, `free_stock`, `lorry_stock`, `lorry_free_stock`) VALUES
...
P_id`,
`cdate
`, `sales`, `purchase_cost`, `expenses`, `daily_profit`) VALUES
...
sale_id`,
`bill_no
`, `item`, `total`, `sale`, `free`, `af_bal`, `total_free`, `af_free`) VALUES
...
`category`,
`item
`, `size`, `load_bal`, `free_load`, `bf_bal`, `bf_free`, `total`, `tot_free`, `create_date`) VALUES
